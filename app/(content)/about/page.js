...
//   return (
//     <section className="text-center my-10 flex flex-col w-full g-[#481818] text-white">
//       {/* <span className="my-10 font-[100] text-3xl text-white">DESPRE NOI</span> */}
//       <div className="mx- -10 flex flex-col  md:flex-row bg-white ">
//         <Image src={img} alt="" className="w-full h-[50vw] md:w-1/2" />
//         <div className="md:w-1/2 text-black mx-10 font-[100] text-start">
//           <h2 className="mb-10 text-2xl text-center  ">
//             Despre Fondatorul Nostru
//           </h2>{" "}
//           <span className="ml-10">În</span> spatele fiecărui aranjament floral
//           stă o persoană cu o pasiune infinită pentru flori și detalii. Lenuta
//           Geangos, fondatoarea și creatoarea din spatele magazinului Floraria
//           Hellen, este o artistă florală cu o experiență de peste [X] ani în
//           domeniu. Pentru ea, fiecare floare spune o poveste, iar fiecare
//           eveniment este o oportunitate de a aduce bucurie și frumusețe în
//           viețile celor din jur. Cu o dragoste profundă pentru natură și o
//           atenție deosebită la detalii, Lenuta Geangos își dedică fiecare zi
//           creării unor opere florale unice, care depășesc așteptările.
...
//             transformăm fiecare eveniment într-o experiență de neuitat. Ne dorim
//             ca florile noastre să fie mai mult decât simple decorațiuni – ele să
//             devină piese centrale care spun o poveste despre dragoste, bucurie
//             și frumusețe. Vă invităm să descoperiți lumea magică a florilor și
//             să ne permiteți să fim parte din momentele speciale din viața
//             voastră!
//           </span>{" "}
//         </div>
//       </div>

//       <span className="text-3xl font-[300] my-10 mb-10 text-black">
//         REALIZARI
//       </span>
//       <ScrollComponent />
