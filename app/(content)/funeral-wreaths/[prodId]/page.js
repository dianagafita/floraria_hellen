...
import { getCurrentDate, getDateForOffer } from "@/components/util/currDate";
          ...
          <form className="flex flex-col w-full h-full max-h-[365px] justify-between mb-20">
            <div className="w-full">
              ...
              <div className="grid md:grid-cols-1 lg:grid-cols-2 w-full items-end">
                ...
                />
                <Input name="deliveryFuneralMessage" label="Mesaj Panglica" />
                <Input name="deliveryFuneralName" label="Nume" />
              </div>
            </div>
